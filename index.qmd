...
description: |
  ...
  *Open: The data are licensed for public reformatting and reuse. Their provenance is documented and code used to transform original data to meet the IRW data standard is available.
