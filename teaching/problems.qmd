---
title: "Problems for Your Problem Sets"
aliases:
  - ../problems.html
---

These are problems that draw on IRW data and may be useful in problem sets for psychometrics classes (especially ones focused on IRT). They come from EDUC 252 at Stanford, and the code they link to is in [ben-domingue/252](https://github.com/ben-domingue/252).

Most of them have since been worked into a lesson in [Psychometrics with the IRW](https://ben-domingue.github.io/irw-course/), the course built on IRW data. Under each problem there's a link to that lesson, which gives the background, the model, and more problems. The course is still in development.

### Logistic regression

[Full lesson in the course: [The likelihood and logistic regression](https://ben-domingue.github.io/irw-course/lessons/likelihood.html) →]{.lesson-link}
...
[Full lesson in the course: [Classical test theory and reliability](https://ben-domingue.github.io/irw-course/lessons/ctt-reliability.html) →]{.lesson-link}
...
[Full lesson in the course: [Where CTT breaks: toward item response models](https://ben-domingue.github.io/irw-course/lessons/ctt-limits.html) →]{.lesson-link}
...
[Full lesson in the course: [From the 1PL to the 4PL](https://ben-domingue.github.io/irw-course/lessons/1pl-to-4pl.html) →]{.lesson-link}
...
[Full lesson in the course: [Model fit and out-of-sample prediction](https://ben-domingue.github.io/irw-course/lessons/fit-prediction.html) →]{.lesson-link}
...
[Full lesson in the course: [Guessing and priors](https://ben-domingue.github.io/irw-course/lessons/guessing-priors.html) →]{.lesson-link}
...
[Full lesson in the course: [Differential item functioning](https://ben-domingue.github.io/irw-course/lessons/dif.html) →]{.lesson-link}
...
[Full lesson in the course: [Measurement invariance under treatment and life events](https://ben-domingue.github.io/irw-course/lessons/invariance-experience.html) →]{.lesson-link}
...
[Full lesson in the course: [Dimensionality and multidimensional IRT](https://ben-domingue.github.io/irw-course/lessons/dimensionality.html) →]{.lesson-link}
...
[Full lesson in the course: [What is an item? Explanatory item response models](https://ben-domingue.github.io/irw-course/lessons/explanatory-irt.html) →]{.lesson-link}
...
[Full lesson in the course: [Models for polytomous responses](https://ben-domingue.github.io/irw-course/lessons/polytomous.html) →]{.lesson-link}
...
[Course lesson planned: IRTree models]{.lesson-link}
...
[Course lesson planned: Response time and the speed-accuracy tradeoff]{.lesson-link}
...
[Full lesson in the course: [Unfolding models](https://ben-domingue.github.io/irw-course/lessons/unfolding.html) →]{.lesson-link}
...
[Course lesson planned: Latent classes and cognitive diagnosis]{.lesson-link}
