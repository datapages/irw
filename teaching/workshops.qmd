---
title: "Workshops & Slides"
---

Materials from workshops and talks that introduced the IRW. The slides are in Google Slides. For a structured introduction to psychometrics with IRW data, see the [course](https://ben-domingue.github.io/irw-course/).

## UTSA IES Pathways Fellows

Slides [here](https://docs.google.com/presentation/d/1mGfK9mWh9UFmy6xuMo4hfP0hIibpQt5XTtX63iwV2s4/edit?slide=id.g3d8ed83bed8_0_11#slide=id.g3d8ed83bed8_0_11).

## IOMW 2025

Information here pertains to the April 2025 demonstration of the IRW at the [IOMW conference](https://www.iomw.net/) held in Boulder, CO. Slides for this training can be found [here](https://docs.google.com/presentation/d/1ZOcMpaRwBfBF9xBdgdO6KBHm7xiGlq6n9WczI2oCrX8/edit?slide=id.g3334d2a9abd_0_4#slide=id.g3334d2a9abd_0_4).

::: {.callout-note collapse="true"}
## Pre-workshop checklist (April 2025)

Prior to attending the conference, please go through the following checklist:
...
A prediction challenge built on Hearts and Flowers data. See the [datathon brief](imps2025-datathon.qmd).
