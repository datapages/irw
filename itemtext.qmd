...
Where the administered wording cannot be recovered and only an English version of the
instrument is available, the English is placed in the base text fields and the
`_translated` fields are left empty.
