...
<img src="/welcome/assets/diagram-cross-classification.svg" alt="एक रंगीन ग्रिड दिखाने वाला आरेख जिसमें id-item सेल हैं, जिसे एक तीर के माध्यम से id, item और resp कॉलम वाली लॉन्ग फॉर्मेट तालिका में बदला गया है, जहाँ प्रत्येक resp सेल का रंग ग्रिड में उसकी मूल सेल के रंग से मेल खाता है।" class="welcome-figure">
