...
<img src="/welcome/assets/diagram-cross-classification.svg" alt="Сетчатая схема, показывающая, что каждый ответ находится на пересечении одного id и одного item." class="welcome-figure">
