...
- **সহজলভ্য (Accessible)।** প্রতিটি ডেটাসেট ওয়েব ব্রাউজার বা `irw` প্যাকেজের মাধ্যমে, একটি বিনামূল্যের অ্যাকাউন্ট দিয়ে, সংগ্রহ করা যায়।
- **আন্তঃকার্যযোগ্য (Interoperable)।** প্রতিটি ডেটাসেট একই সরল কাঠামোতে (নিচে বর্ণিত) রূপান্তরিত, যাতে একই বিশ্লেষণ কোড সামান্য বা কোনো পরিবর্তন ছাড়াই বহু ডেটাসেটে চালানো যায়।
...
<img src="/welcome/assets/diagram-cross-classification.svg" alt="একটি রঙিন গ্রিড দেখানো চিত্র, যেখানে id-item সেলগুলো একটি তীরচিহ্নের মাধ্যমে id, item এবং resp কলামসহ একটি লং ফরম্যাট টেবিলে রূপান্তরিত হয়েছে, যেখানে প্রতিটি resp সেলের রঙ গ্রিডে তার উৎস সেলের রঙের সাথে মিলে যায়।" class="welcome-figure">
