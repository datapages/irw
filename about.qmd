...
<div class="contributor-card">
  ...
  <div class="contributor-name"><a href="https://mathbecsan.com/" target="_blank">Mathias Becerra Sanchez</a></div>
</div>
...
<div class="contributor-card">
  <div class="contributor-avatar">
    <img src="resources/img/contributors/stacy-cremer.jpg" alt="Stacy Cremer"
         onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="contributor-initials" style="display:none">SC</div>
  </div>
  <div class="contributor-name"><a href="https://www.linkedin.com/in/stacy-cremer-715110272/" target="_blank">Stacy Cremer</a></div>
</div>

<div class="contributor-card">
  <div class="contributor-avatar">
    <img src="resources/img/contributors/aryan-sudhir.jpg" alt="Aryan Sudhir"
         onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="contributor-initials" style="display:none">AS</div>
  </div>
  <div class="contributor-name">Aryan Sudhir</div>
</div>

<div class="contributor-card">
  <div class="contributor-avatar">
    <img src="resources/img/contributors/xinyu-lu.jpg" alt="Xinyu Lu"
         onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="contributor-initials" style="display:none">XL</div>
  </div>
  <div class="contributor-name"><a href="https://profiles.stanford.edu/xinyu-lu" target="_blank">Xinyu Lu</a></div>
</div>

<div class="contributor-card">
  <div class="contributor-avatar">
    <img src="resources/img/contributors/abhinav-alwarappan.jpg" alt="Abhinav Alwarappan"
         onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="contributor-initials" style="display:none">AA</div>
  </div>
  <div class="contributor-name">Abhinav Alwarappan</div>
</div>
