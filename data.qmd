...
// Search input to filter dataset names
viewof dataset_search = Inputs.search(Array.from(dataset_map.keys()), {
  label: "Search datasets",
  placeholder: "Type to search..."
})

// Dataset selector from filtered results
viewof dataset = Inputs.select(
  new Map(dataset_search.map(name => [name, dataset_map.get(name)])),
