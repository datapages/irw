...
* `time_limit`: Time limit for the cohort.
...
* Response time is potentially a valuable predictor of response accuracy. In particular, note that there were different time limits in place for the two cohorts (which differed in age, hence the different time limts). 
