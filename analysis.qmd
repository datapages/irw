...
Below we offer examples in both Python and R for how to access data programatically from the IRW. In R, we make use of the `irwpkg` which was written to help facilitate handling of IRW data in R; more details available [here](https://hansorlee.github.io/irwpkg/).
