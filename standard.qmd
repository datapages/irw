...
<<<<<<< HEAD
- `resp` This is the item response. It is coded as a numeric value that can be directly utilized in various psychometric models. 
=======
...
>>>>>>> 44a9a6f1b7e7526b9cd263ccca4f820d301d409d
