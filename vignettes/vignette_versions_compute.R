...
CACHES <- list(
  ...
  # Only the caches fit to IRW data. The sim and floor-calibration caches are
  # pure simulation, and guessing_gsweep_results.rds predates the v52.0 ENEM
  # rebuild (2026-09-04), so letting it in would date the page by a run it
  # no longer reflects -- or, under "newest wins", hide that it is older.
