...
- [ ] Audit all vignettes and R scripts for manual IMV calculations and replace with `imv` R package calls (currently `vignettes/imv.qmd` already uses the package; check other vignettes for any ad-hoc implementations)
