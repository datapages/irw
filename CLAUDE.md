...
- [ ] Add plotly hover annotations to other vignette figures — `dutch_identity.qmd` has one example (`fig-manifest-dist`); consider applying the same pattern elsewhere for richer interactivity
