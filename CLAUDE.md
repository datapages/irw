...
- [x] **Gender DIF omnibus vignette** — Omnibus DIF/measurement invariance by gender across all IRW datasets with `cov_gender` or `cov_sex`. Compute script at `vignettes/gender_dif_compute.R`.
